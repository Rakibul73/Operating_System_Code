...
def printData(process_data, average_turnaround_time, average_waiting_time, process_working_sequence):
    ...
    print("Process_ID\tArrival_Time\tBurst_Time\tPriority\tCompleted\tExit_Time\tTurnaround_Time\tWaiting_Time")
    for i in range(len(process_data)):
...
for i in range(no_of_processes):
    ...
    temporary.extend([i+1, arrival_time, burst_time, priority, 0])
